    ...
    <?php while (loop_items()): ?>
        <div class="item hentry">
		  ...
		  elseif (item_has_type('Document')):
    			echo link_to_item('<img src="'.img('pdficon_large.png').'" />');
		  elseif (item_has_type('Publication')):
    			echo link_to_item('<img src="'.img('pdficon_large.png').'" />');
		  elseif (item_has_type('Moving Image')):
			echo link_to_item('<img src="'.img('4b.png').'" />');
		  elseif (item_has_type('Sound')):
			echo link_to_item('<img src="'.img('3b.png').'" />');
		  else:
			//echo link_to_item('<img src="'.img('liblogo2.png').'" />');
            	  endif; 
		?>
